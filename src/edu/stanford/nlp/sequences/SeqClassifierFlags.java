...
public class SeqClassifierFlags implements Serializable {
  ...
  //WCN
  public boolean useWcn = false;
  public boolean useWCNTrigram = false;
  public boolean useWCNCluster = false;
  ...
  public void setProperties(Properties props, boolean printProps) {
    ...
    for (Enumeration e = props.propertyNames(); e.hasMoreElements();) {
      ...
      } else if (key.equalsIgnoreCase("useWcn")){
          useWcn = Boolean.parseBoolean(val);
      }
      else if (key.equalsIgnoreCase("useWCNTrigram")){
          useWCNTrigram = Boolean.parseBoolean(val);
      }
      else if (key.equalsIgnoreCase("useWCNCluster")){
          useWCNCluster = Boolean.parseBoolean(val);
      }
